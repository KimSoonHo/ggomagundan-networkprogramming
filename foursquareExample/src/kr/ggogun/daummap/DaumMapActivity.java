...
import kr.ggogun.foursquare.R.drawable;
...
public class DaumMapActivity extends Activity 
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        double[] loc = intent.getExtras().getDoubleArray("location");
        Log.d("PBS","Recieve  " +  loc);
        ...
        mapView.setDaumMapApiKey("51a83437da10c3cccd73786822fdedc092c7541b");
        // DAUM MAP API KEY	
       ...
       // Log.d("PBS","Recieve  " +  Double.toString(loc[0]) + ",  " + Double.toString(loc[1]));
        mapView.setMapCenterPoint(MapPoint.mapPointWithGeoCoord(loc[0], loc[1]), true);
        
        
        poiItem = new MapPOIItem();
		poiItem.setItemName("Select Item");
		poiItem.setMapPoint(MapPoint.mapPointWithGeoCoord(loc[0], loc[1]));
...
//					{
//						reverseGeoCoder = new MapReverseGeoCoder("DAUM_LOCAL_DEMO_APIKEY", mapView.getMapCenterPoint(), DaumMapActivity.this, DaumMapActivity.this);
