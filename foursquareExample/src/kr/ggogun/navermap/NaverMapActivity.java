...
public class NaverMapActivity extends NMapActivity {
	...
	private static final String API_KEY = "11fd3fcbf8d8fac9cbf276b2a5e6039f";
	...
	public void onCreate(Bundle savedInstanceState) {
	   ...
	   loc = intent.getExtras().getDoubleArray("location");		
	   NMAP_LOCATION_DEFAULT = new NGeoPoint(loc[1], loc[0]);
		// create map view
